...
const AuctionTimer: React.FC<AuctionTimerProps> = ({ start, end, component }) => {
  ...
  return (
    <>
      {
        component === "banner" &&
        <div className="relative mb-5 w-fit min-w-[268px] overflow-hidden rounded-2xl border-2 border-[#605D96]">
          <div
            className="trasnis absolute h-full bg-[#605D96]"
          ...
          {text !== "Ended" ? (
            <div className="relative z-10 m-4 flex text-center text-base font-medium text-heading">
              ...
              <div className="flex items-center">
                <h4 className="w-[18px]">
                  {timer[0] !== undefined ? timer[0] : "0"}
                </h4>
                <h6>D</h6>
              </div>
              <div className="flex items-center pl-[8px]">
                <h4 className="w-[18px]">
                  {timer[1] !== undefined ? timer[1] : "0"}
                </h4>
                <h6 className="ml-1">H</h6>
              </div>
              <div className="flex items-center pl-[8px]">
                <h4 className="w-[18px]">
                  {timer[2] !== undefined ? timer[2] : "0"}
                </h4>
                <h6 className="ml-1">M</h6>
              </div>
              <div className="flex items-center pl-[8px]">
                <h4 className="w-[18px]">
                  {timer[3] !== undefined ? timer[3] : "0"}
                </h4>
