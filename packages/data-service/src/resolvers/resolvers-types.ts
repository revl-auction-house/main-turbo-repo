...
export type ResolversTypes = {
  Auction: ResolverTypeWrapper<
    Omit<Auction, "auctionData"> & {
      auctionData?: Maybe<ResolversTypes["AuctionType"]>;
    }
  >;
  AuctionType: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>["AuctionType"]
  >;
...
export type ResolversParentTypes = {
  Auction: Omit<Auction, "auctionData"> & {
    auctionData?: Maybe<ResolversParentTypes["AuctionType"]>;
  };
...
export type AuctionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["Auction"] = ResolversParentTypes["Auction"],
> = {
  auctionData?: Resolver<
    Maybe<ResolversTypes["AuctionType"]>,
    ParentType,
    ContextType
  >;
...
export type AuctionTypeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["AuctionType"] = ResolversParentTypes["AuctionType"],
> = {
...
export type BlindFirstPriceAuctionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["BlindFirstPriceAuction"] = ResolversParentTypes["BlindFirstPriceAuction"],
> = {
...
export type BlindSecondPriceAuctionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["BlindSecondPriceAuction"] = ResolversParentTypes["BlindSecondPriceAuction"],
> = {
  bids?: Resolver<Array<ResolversTypes["Bid"]>, ParentType, ContextType>;
  endTime?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type DutchAuctionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["DutchAuction"] = ResolversParentTypes["DutchAuction"],
> = {
...
export type EnglishAuctionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes["EnglishAuction"] = ResolversParentTypes["EnglishAuction"],
> = {
...
> = {
  setKeyValue?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType,
    RequireFields<MutationSetKeyValueArgs, "key" | "value">
  >;
};
...
> = {
  auction?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QueryAuctionArgs>
  >;
  auctions?: Resolver<
    Array<ResolversTypes["Auction"]>,
    ParentType,
    ContextType,
    Partial<QueryAuctionsArgs>
  >;
  collection?: Resolver<
    Maybe<ResolversTypes["Collection"]>,
    ParentType,
    ContextType,
    RequireFields<QueryCollectionArgs, "address">
  >;
  ...
  getValue?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetValueArgs, "key">
  >;
  nft?: Resolver<
    Maybe<ResolversTypes["NFT"]>,
    ParentType,
    ContextType,
    RequireFields<QueryNftArgs, "collection" | "idx">
  >;
  nfts?: Resolver<
    Array<ResolversTypes["NFT"]>,
    ParentType,
    ContextType,
    Partial<QueryNftsArgs>
  >;
  topBids?: Resolver<
    Array<ResolversTypes["Bid"]>,
    ParentType,
    ContextType,
    Partial<QueryTopBidsArgs>
  >;
  userBids?: Resolver<
    Array<ResolversTypes["Bid"]>,
    ParentType,
    ContextType,
    RequireFields<QueryUserBidsArgs, "address">
  >;
};
